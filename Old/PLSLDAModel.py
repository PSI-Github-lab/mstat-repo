...
def main():
    ...
    rnd_state = 42
    analysis = MSDataAnalyser(preprocess, n_component_pca, rnd_state, da_mode=2)
    ...
    if curve_flag:
        ...
        plot_learning_curve(analysis.dimr_pipeline, title, file_reader.getTICNormalization(), labels, n_component_pca, axes=axes, cv=cv, train_sizes=train_sizes)
