...
class InteractivePlot:
    ...
    def __init__(self, training_file_reader, test_file_reader, pipeline, n_std) -> None:
        ...
        self.initAxis1(ax1_color, self.colormap, label_names, qda_classifier, n_std)
    ...
    def initAxis1(self, title_color, colormap, label_names, qda_classifier, n_std):
        self.sc = self.ax1.scatter(self.plot_frame['ld1'], self.plot_frame['ld2'], self.plot_frame['ld3'], color=colormap(self.plot_frame['color']))
    ...
    def initAxis2(self, lda, title_color):
        ...
        self.ax2.set_title('Variance', color=title_color)
        self.ax2.set_xlabel('LDA Component', color=title_color)
        self.ax2.set_ylabel('Explained Variance Ratio (%)', color=title_color)
